...
/* themes/jks/templates/form-element.html.twig */
class __TwigTemplate_1f54fd55a7794f210de121ee49f07b56597b3f9a1279df226c6f8872dc6b64d5 extends Twig_Template
{
...
(isset($context["description_display"]) ? $context["description_display"] : null) == "invisible")) ? ("visually-hidden") : ("")));
        // line 67
        echo "<div";
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute($this->getAttribute((isset($context["attributes"]) ? $context["attributes"] : null), "removeClass", array(0 => (isset($context["classes"]) ? $context["classes"] : null)), "method"), "addClass", array(0 => "form-group"), "method"), "html", null, true));
        echo ">
  ";
        // line 68
...
";
    ...
    {
        return "themes/jks/templates/form-element.html.twig";
    }
...
%}
<div{{ attributes.removeClass(classes).addClass('form-group') }}>
